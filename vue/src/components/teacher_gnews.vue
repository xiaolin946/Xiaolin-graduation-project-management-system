<template>
  <h3 style="margin-left: 40%; margin-bottom: 10px">消息管理</h3>
  ...
  >
    ...
    >
      ...
      <el-form-item style="margin-bottom: 4vh; width: 40vh" label="接收用户" prop="guser">
        <el-select v-model="statusData.formData.guser" placeholder="用户">
          <el-option label="Student" value="Student"/>
          <el-option label="z01" value="z01"/>
        </el-select>
      </el-form-item>
  ...
  <el-table :data="statusData.tableData" style="height:72%; width: 100%; margin-bottom: 5px">
    ...
    <el-table-column prop="xstatus" label="消息类别" width="80" />
    ...
    <el-table-column prop="pdate" label="消息发送时间" width="180"/>
...
const fresh = () =>{
  request.get("/News/mynews_findPage", {
    params: {
